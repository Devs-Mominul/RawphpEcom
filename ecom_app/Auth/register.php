              ...
              <div class="card card-plain">
                  ...
                  <form action="./Auth/register_post.php"  method="POST">
                    ...
                    <div class="input-group input-group-outline mb-3">
                      ...
                      <?php if(isset($_SESSION['name'] )) : ?>
                        <div class="text-danger d-block "><br/><?=$_SESSION['name']?></div>
                      <?php endif;  ?>
                    ...
                    <div class="input-group input-group-outline mb-3">
                      ...
                      <?php if(isset($_SESSION['email'] )) : ?>
                        <div class="text-danger d-block"><br/><?=$_SESSION['email']?></div>
                      <?php endif;  ?>
                    </div>
                    <div class="input-group input-group-outline mb-3">
                      ...
                      <?php if(isset($_SESSION['password'] )) : ?>
                        <div class="text-danger d-block"><br/><?=$_SESSION['password']?></div>
                      <?php endif;  ?>
                    </div>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-2 text-sm mx-auto">
                    ...
                    <a href="./Auth/login.php" class="text-primary text-gradient font-weight-bold">Sign in</a>
                  </p>
                </div>
              </div>
            </div>
